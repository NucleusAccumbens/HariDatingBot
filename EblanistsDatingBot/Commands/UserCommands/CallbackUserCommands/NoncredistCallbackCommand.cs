...
public class NoncredistCallbackCommand : BaseCallbackCommand
{
    ...
    private readonly string _messageText = "are you childfree?";
    ...
    public override async Task CallbackExecute(Update update, ITelegramBotClient client)
    {
        if (update.CallbackQuery != null && update.CallbackQuery.Message != null)
        {
            ...
            try
            {
                ...
                if (update.CallbackQuery.Data == "bYes") user.IsBeliever = true;

                if (update.CallbackQuery.Data == "bNo") user.IsBeliever = false;
